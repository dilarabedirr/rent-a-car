...
public class PaymentManager implements PaymentService {
    ...
    public final PaymentBusinessRules rules;
    ...
    public void processRentalPayment(CreateRentalPaymentRequest request) {
        rules.checkIfPaymentIsValid(request); //verilen kart bilgileri doğru mu
        Payment payment = repository.findByCardNumber(request.getCardNumber());
        rules.checkIfBalanceIsEnough(payment.getBalance(), request.getPrice());// bakiye yeterli mi
